...
Try {
	...
	[string]$appScriptDate = '07/05/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'wireshark,dumpcap' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$dirFiles\Wireshark-win64-2.6.1.exe" -Parameters '/S' -WindowStyle 'Hidden'
		Execute-Process -Path "$dirFiles\winpcap-nmap-4.13.exe" -Parameters '/S' -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'wireshark,dumpcap' -CloseAppsCountdown 60
		...
		Execute-Process -Path "$envProgramFiles\Wireshark\uninstall.exe" -Parameters "/S"
		Execute-Process -Path "$envProgramFiles\WinPCap\uninstall.exe" -Parameters "/S"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAIYa6E2Z9q4KiX
# GpH5dvl31LNqu9KgV8+67wnwvY40JKCCGdcwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BDEiBCBZ1OHClEnOPtgkKVMZFGm8InEkfkMYdk0K32RCH29I2DANBgkqhkiG9w0B
# AQEFAASCAQBu3IwuImVNG7FAWj8sjCdtHaMv+gj3h+Q7FK80p6nuhSlc6q/h2aIE
# tLOVS2F5YSjFyZHKkTlQ4OCYTk/6Ol7JW9WiSAGxwyyt86szEQ1a+tKcBwKXZDkW
# xmZGg2/RkNg0oH8fk89KKSNRWOz5ERubw5DcKPNr82QO7Ena4LcXQ9nq2bYkJoh2
# JfXCafC678HCRFDcQd80iM7qRXEoO2/9LHmM5OpqHKI6OhNVln5jmbw2Nfn2l6e4
# daeTqk6M6mWRuzkvC2iDcp3+yRhE5htuutT6Fh8YTV6CGan7emnjdRQnfRvxYBnM
# oxDgRqhFIsKZ5Voq8aga+Op6Sjedj6J9oYICojCCAp4GCSqGSIb3DQEJBjGCAo8w
# ggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# 1pmnZJc+8fhCfukZzFNBFDAJBgUrDgMCGgUAoIH9MBgGCSqGSIb3DQEJAzELBgkq
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE4MDcwNTIwMTcyMVowIwYJKoZIhvcN
# AQkEMRYEFDxhKR4n8pNZqnOUgoGt6slZGBaAMIGdBgsqhkiG9w0BCRACDDGBjTCB
# ijCBhzCBhAQUY7gvq2H1g5CWlQULACScUCkz7HkwbDBWpFQwUjELMAkGA1UEBhMC
# QkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNp
# Z24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh1pmnZJc+8fhCfukZzFNBFDANBgkq
# hkiG9w0BAQEFAASCAQAQnKd0G3hLus5Kbf3x7lFZMLGzD5OFMnfO1T6buSO8bFEE
# BLdRYdAh9k/c/gFANXjgLxcFYbNnFTrn5f95opU4L4B7quBvvCLsw8Nwos26OxcW
# aMg2m1e9JnCKnu8VxNNz+1VLGY0pcnWs3EbkMu//HBNfVZG57JDQmRtv0BI3ldiJ
# 1j17BTbYkL7RIuI4IA6VBPd5tztsHlnY6ms8AJbrnW0BcMTjx5lnVcBHsFCOw1eG
# 2Wwb5QC1sLSxFY/g+iHvtJxJJuanBYf4y5OTGVvqXrIkNn1GzaqLzzx2F5PFbIwO
# dsREkr8QBiXz/oWjGXRCtXBMyPJZwRQsFVtd9Tr/
